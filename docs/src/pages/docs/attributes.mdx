...
| `data-chart-horizontal` | flag | — | Horizontal bar chart. `bar` only. |
| `data-chart-stacked` | flag | — | Stacked bar chart. `bar` only. |
...
| Attribute | Type | Default | Description |
|-----------|------|---------|-------------|
| `data-chart-animate` | flag | — | Enable entrance animations |
...
| Attribute | Type | Default | Description |
|-----------|------|---------|-------------|
| `data-chart-source` | flag | — | Show "Show table" toggle button |
| `data-chart-debug` | flag | — | Log parsed data to console |
